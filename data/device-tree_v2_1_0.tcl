...
proc edk_override_update {} {
	...
	debug info "edk_override_update"
...
proc generate_device_tree {filepath bootargs {consoleip ""}} {
	...
	debug info "generate_device_tree 1"
...
# Clock port summary
	...
	debug info "generate_device_tree 2"
...
# 			lappend ip_tree $tree
	...
	debug info "generate_device_tree 3"
	...
	debug info "generate_device_tree 4"
...
proc gener_slave {node slave intc {force_type ""} {busif_handle ""}} {
	...
	switch -exact $type {
		...
		"axi_dma" {
			...
			if {[string equal $axidma_busif_handle ""] == 0} {
				debug info "axi_dma MM2S"
				...
				debug info "$mhs_handle $axidma_name"
				set axidma_ip_handle_name [xget_hw_name $axidma_ip_handle]
				debug info "$mhs_handle $axidma_ip_handle"
				set connected_ip_handle [xget_hw_parent_handle $axidma_ip_handle]
				set connected_ip_name [xget_hw_name $connected_ip_handle]
				set connected_ip_type [xget_hw_value $connected_ip_handle]
			} else {
				debug info "axi_dma S2MM"

				set axidma_busif_handle [xget_hw_busif_handle $slave "S_AXIS_S2MM"]
				debug info "$axidma_busif_handle"
				set axidma_name [xget_hw_value $axidma_busif_handle]
				debug info "$mhs_handle $axidma_name"
				set axidma_ip_handle [xget_hw_connected_busifs_handle $mhs_handle $axidma_name "SLAVE"]
				debug info "$axidma_ip_handle"
				set axidma_ip_handle_name [xget_hw_name $axidma_ip_handle]
				set connected_ip_handle [xget_hw_parent_handle $axidma_ip_handle]
				set connected_ip_name [xget_hw_name $connected_ip_handle]
				set connected_ip_type [xget_hw_value $connected_ip_handle]
